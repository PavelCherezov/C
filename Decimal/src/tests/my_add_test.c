...
START_TEST(add_test_1) {
  ...
  my_decimal minus_one = {
      {0x00000001, 0x00000000, 0x00000000, 0x80000000}};  //      -1
  my_decimal plus_null = {
      {0x00000000, 0x00000000, 0x00000000, 0x00000000}};  //       0
  my_decimal minus_null = {
      {0x00000000, 0x00000000, 0x00000000, 0x80000000}};  //      -0
  my_decimal result = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}};

  // 0 + 1 = 1
  ck_assert_int_eq(OK, my_add(plus_null, plus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_one.bits[i], result.bits[i]);
  }
  // 1 + 0 = 1
  ck_assert_int_eq(OK, my_add(plus_one, plus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_one.bits[i], result.bits[i]);
  }
  // 0 + (-1) = (-1)
  ck_assert_int_eq(OK, my_add(plus_null, minus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(minus_one.bits[i], result.bits[i]);
  }
  // (-1) + 0 = (-1)
  ck_assert_int_eq(OK, my_add(minus_one, plus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(minus_one.bits[i], result.bits[i]);
  }
  // 0 + 0 = 0
  ck_assert_int_eq(OK, my_add(plus_null, plus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // 0 + (-0) = 0
  ck_assert_int_eq(OK, my_add(plus_null, minus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // (-0) + 0 = 0
  ck_assert_int_eq(OK, my_add(minus_null, plus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // (-0) + (-0) = 0
  ck_assert_int_eq(OK, my_add(minus_null, minus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // (-0) + 1 = 1
  ck_assert_int_eq(OK, my_add(minus_null, plus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_one.bits[i], result.bits[i]);
  }
  // 1 + (-0) = 1
  ck_assert_int_eq(OK, my_add(plus_one, minus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_one.bits[i], result.bits[i]);
  }
  // (-0) + (-1) = (-1)
  ck_assert_int_eq(OK, my_add(minus_null, minus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(minus_one.bits[i], result.bits[i]);
  }
  // (-1) + (-0) = (-1)
  ck_assert_int_eq(OK, my_add(minus_one, minus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(minus_one.bits[i], result.bits[i]);
  }
}
...
START_TEST(add_test_2) {
  my_decimal value_1 = {{0x89E7FFFF, 0x00000000, 0x00000000,
...
START_TEST(add_test_4) {
  ...
  my_decimal answer_2 = {{0xB23FFC17, 0x0000021A, 0x00000001,
                           0x00080000}};  //      184467463873.92494615
  my_decimal answer_3 = {{0xE367697F, 0x0623CFEE, 0x00012189,
                           0x000C0000}};  // 1367291559913.239012141439
  my_decimal answer_4 = {{0xFFFFFFFE, 0xFFFFFFFF, 0x00000001,
                           0x00080000}};  //      368934881474.19103230
  my_decimal answer_5 = {{0xFFFFD8EF, 0x05D19D1B, 0x00014899,
...
START_TEST(add_test_6) {
  my_decimal max = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
...
START_TEST(add_test_7) {
  my_decimal min = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
  ...
  // -79228162514264337593543950335 + -79228162514264337593543950335 = NUMBER IS
  // TOO SMALL!
  ck_assert_int_eq(SMALL, my_add(min, min, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // -79228162514264337593543950335 + 0 = -79228162514264337593543950335
  ck_assert_int_eq(OK, my_add(min, plus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(min.bits[i], result.bits[i]);
  }
  // 0 + -79228162514264337593543950335 = -79228162514264337593543950335
  ck_assert_int_eq(OK, my_add(plus_null, min, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(min.bits[i], result.bits[i]);
  }
  // -79228162514264337593543950335 + (-0) = -79228162514264337593543950335
  ck_assert_int_eq(OK, my_add(min, minus_null, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(min.bits[i], result.bits[i]);
  }
  // (-0) + -79228162514264337593543950335 = -79228162514264337593543950335
  ck_assert_int_eq(OK, my_add(minus_null, min, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(min.bits[i], result.bits[i]);
  }
  // -79228162514264337593543950335 + 1 = -79228162514264337593543950334
  ck_assert_int_eq(OK, my_add(min, plus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(answer_1.bits[i], result.bits[i]);
  }
  // 1 + -79228162514264337593543950335 = -79228162514264337593543950334
  ck_assert_int_eq(OK, my_add(plus_one, min, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(answer_1.bits[i], result.bits[i]);
  }
  // -79228162514264337593543950335 + (-1) = NUMBER IS TOO SMALL!
  ck_assert_int_eq(SMALL, my_add(min, minus_one, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
  // (-1) + -79228162514264337593543950335 = NUMBER IS TOO SMALL!
  ck_assert_int_eq(SMALL, my_add(minus_one, min, &result));
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(plus_null.bits[i], result.bits[i]);
  }
}
...
START_TEST(add_test_8) {
  my_decimal max = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                      0x00000000}};  //    79228162514264337593543950335
  my_decimal value_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF,
                          0x00000000}};  //    39614081257132168796771975167
  my_decimal value_2 = {{0x00000000, 0x00000000, 0x80000000,
                          0x00000000}};  //    39614081257132168796771975168
  my_decimal value_3 = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
                          0x00000000}};  //    79228162514264337593543950334
  my_decimal value_4 = {{0x00000003, 0x00000000, 0x00000000,
                          0x00010000}};  //                              0.3
  my_decimal value_5 = {{0x00000006, 0x00000000, 0x00000000,
                          0x00010000}};  //                              0.6
  my_decimal plus_null = {{0x00000000, 0x00000000, 0x00000000,
                            0x00000000}};  //                                0
...
Suite* my_add_suite(void) {
  Suite* s;
  s = suite_create("\033[33mmy_add\033[0m");

  TCase* tc_core;
  tc_core = tcase_create("my_add_core");
